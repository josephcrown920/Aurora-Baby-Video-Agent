export type ProductionAgentRole="director"|"vision"|"character"|"world"|"storyboard"|"editor"|"audio"|"qa";
...
{role:"editor",model:"dola-seed-2-1-turbo-260628",objective:"Map approved plans into reversible multi-layer timeline operations.",dependsOn:["storyboard"]},
